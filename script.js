...
function handleMessage() {
  ...
  setTimeout(() => {
    ...
    // Разработчик
      ...
      reply = "Սկսնակ ծրագրավորողներին ես միշտ կտայի հետևյալ խորհուրդները ՝1․ Մի վախեցիր սխալվելուց   Սխալվելը սովորելու մի մասն են։ 2․ Մի ամաչիր օգնություն խնդրելուց Խնդիրներ ունենալը նորմալ է։ 3․ երբեք մի հանձնվիր հանձնվելը քեզ կթուլացնի, ավելի խորացիր ու կկարողանաս՝; 
    }
